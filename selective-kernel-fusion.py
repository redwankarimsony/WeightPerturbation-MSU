...
if __name__ == '__main__':
    ...
    modelA = os.path.join(args.resultPath, args.perturbation, "DenseNet161GaussianNoise-0.9087-.pth")
    modelB = os.path.join(args.resultPath, args.perturbation, "DenseNet161GaussianNoise-0.9416-.pth")
    ...
    livDetIris17_ds = LivDetIris2020(imageFolder=args.imageFolder,
                                        splitPath='Data-Splits/LivDet-Iris-2017/test_train_split06-Seg.csv')
                                    #  splitPath=args.splitPath)
    ...
    modelB_preds = getPrediction(model=modelB, dataLoader=livDetIris17_dl, device=torch.device("cuda:0"), message="modelB")
    modelB = None
    modelA = None
