"""
***********************************************************************
* GitHub Profile: [redwankarimsony](https://github.com/redwankarimsony)
* ***********************************************************************
* Name: Redwan Sony
* Role: Graduate Research Assistant
* Location: iPRoBe Lab, Michigan State University, USA
* Email: sonymd@msu.edu
* LinkedIn: [Redwan Karim Sony](https://www.linkedin.com/in/redwankarimsony)
* -------------------------------------------------------------------
***********************************************************************
"""
...
if __name__ == "__main__":
    ...
    # Loading weights
    weights = torch.load(
        os.path.join(f"Results/LivDet-Iris-2020/GaussianNoise/DenseNet161GaussianNoise-{weight_key}-.pth"))
    ...
    # Calculating TDR at 0.2% FDR [IARPA specified evaluation metric]
    ...
    print(f"Results Saved to: Results/LivDet-Iris-2020/GaussianNoise/{weight_key[2:]}-original.pkl")
